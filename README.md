...
- **تخصيص صفحة النتائج (Display Settings)**: يتحكم الأدمن بكل قسم من صفحة النتائج على حدة — إظهار/إخفاء، نوع الرسم البياني (مساحي/خطي/أعمدة للمقارنة الفصلية، أعمدة/خطي للمقارنة السنوية، أعمدة/دائري لأفضل الفئات)، واختيار تلقائي (الأفضل أداءً) أو يدوي لفئات ومؤشرات محددة تُعرض في صفحة النتائج.
